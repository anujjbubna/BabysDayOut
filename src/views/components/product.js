        ...
        return (
            <div id="product" className="box-border w-screen h-screen text-white bg-baby-pink snap-start shrink-0 snap-always">
                <div className="w-full h-full lg:pt-28 pt-20">
                    <h1 className="text-4xl lg:text-5xl xl:text-6xl text-center lg:pb-8 pb-6 text-slate-700 drop-shadow-xl lg:pt-0 px-4">So what is BabysDayOut?</h1>
                    <p className="w-full pt-0 lg:pt-2 xl:pt-4 px-2 text-center italic drop-shadow-xl text-slate-800 lg:text-base text-sm">It is the future of daycare... and even the children.</p>
                    <div className="grid lg:grid-cols-2 grid-rows-2 xl:mt-10 md:mt-6 mt-4 justify-items-center w-full bg-white drop-shadow-xl h-3/5">
                        <p className="text-center xl:text-2xl lg:leading-loose xl:leading-extra-loose 2xl:leading-extra-loose md:leading-loose lg:pr-10 lg:pl-16 md:px-24 px-3 lg:w-4/5 text-slate-700 h-full
                                     md:text-xl lg:text-lg 2xl:text-3xl leading-relaxed 2xl:mt-24 xl:mt-14 lg:mt-10 mt-8 md:mt-10">
                        ...
                        <div className="text-slate-800 2xl:text-2xl xl:text-xl md:text-lg text-sm lg:space-y-24 xl:space-y-32
                                        lg:py-14 xl:pt-16 xl:pb-24 py-4 grid grid-cols-2 lg:grid-cols-1 lg:grid-rows-2">
                            <div className="w-3/4 mx-auto justify-items-center xl:space-y-5 md:space-y-2 space-y-5">
                            ...
                            <div className="w-3/4 mx-auto justify-items-center xl:space-y-5 md:space-y-2 xl:pt-8 space-y-5">
                                <div className="inline-block">
                    ...
                    <div className="flex justify-center w-3/10 2xl:pt-16 xl:pt-12 md:pt-20 lg:pt-8 pt-10
